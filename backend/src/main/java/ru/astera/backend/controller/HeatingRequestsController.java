...
public class HeatingRequestsController {
    ...
    @PostMapping
    public ResponseEntity<HeatingRequestDto> create(@RequestBody @Valid HeatingRequestCreateDto body) {
    ...
    public ResponseEntity<Page<HeatingRequestDto>> list(
        ...
        return ResponseEntity.ok(service.list(leadId, status, fuelType, pageable));
    }
